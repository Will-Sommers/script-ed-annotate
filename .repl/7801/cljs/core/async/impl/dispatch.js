...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14452 = 0;while(true){
var m_14453 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14453 == null))
{} else
{m_14453.call(null);
if((count_14452 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14454 = (count_14452 + 1);
count_14452 = G__14454;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__5622__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__5622__auto__)
