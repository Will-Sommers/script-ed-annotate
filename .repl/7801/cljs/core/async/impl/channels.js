...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14458 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14458 = (function (val,box,meta14459){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14458.cljs$lang$type = true;
cljs.core.async.impl.channels.t14458.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14458";
cljs.core.async.impl.channels.t14458.cljs$lang$ctorPrWriter = (function (this__6201__auto__,writer__6202__auto__,opt__6203__auto__){return cljs.core._write.call(null,writer__6202__auto__,"cljs.core.async.impl.channels/t14458");
});
cljs.core.async.impl.channels.t14458.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14458.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14460){var self__ = this;
var _14460__$1 = this;return self__.meta14459;
});
cljs.core.async.impl.channels.t14458.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14460,meta14459__$1){var self__ = this;
var _14460__$1 = this;return (new cljs.core.async.impl.channels.t14458(self__.val,self__.box,meta14459__$1));
});
cljs.core.async.impl.channels.__GT_t14458 = (function __GT_t14458(val__$1,box__$1,meta14459){return (new cljs.core.async.impl.channels.t14458(val__$1,box__$1,meta14459));
});
}
return (new cljs.core.async.impl.channels.t14458(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__6204__auto__,writer__6205__auto__,opts__6206__auto__){return cljs.core._write.call(null,writer__6205__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__6201__auto__,writer__6202__auto__,opt__6203__auto__){return cljs.core._write.call(null,writer__6202__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_14461 = self__.takes.pop();if((taker_14461 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14461))
{var take_cb_14462 = cljs.core.async.impl.protocols.commit.call(null,taker_14461);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14462,taker_14461){
return (function (){return take_cb_14462.call(null,null);
});})(take_cb_14462,taker_14461))
);
} else
{}
{
