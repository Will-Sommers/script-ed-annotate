...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__6201__auto__,writer__6202__auto__,opt__6203__auto__){return cljs.core._write.call(null,writer__6202__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14361 = 0;while(true){
if((i_14361 < arr.length))
{(arr[i_14361] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__6201__auto__,writer__6202__auto__,opt__6203__auto__){return cljs.core._write.call(null,writer__6202__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_14368 = (self__.level + 1);while(true){
if((i_14368 <= (new_level + 1)))
{(update[i_14368] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14370 = 0;while(true){
if((i_14370 <= self__.level))
{var links_14371 = (update[i_14370]).forward;if(((links_14371[i_14370]) === x__$1))
{(links_14371[i_14370] = (x__$1.forward[i_14370]));
{
var G__14372 = (i_14370 + 1);
i_14370 = G__14372;
continue;
}
} else
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__5634__auto__ = (cljs.core.truth_((function (){var and__5622__auto__ = me;if(cljs.core.truth_(and__5622__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__5622__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__5634__auto__))
