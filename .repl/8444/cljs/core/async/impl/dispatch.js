...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14458 = 0;while(true){
var m_14459 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14459 == null))
{} else
{m_14459.call(null);
if((count_14458 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14460 = (count_14458 + 1);
count_14458 = G__14460;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__5624__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__5624__auto__)
