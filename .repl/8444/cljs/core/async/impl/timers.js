...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__6203__auto__,writer__6204__auto__,opt__6205__auto__){return cljs.core._write.call(null,writer__6204__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14367 = 0;while(true){
if((i_14367 < arr.length))
{(arr[i_14367] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__6203__auto__,writer__6204__auto__,opt__6205__auto__){return cljs.core._write.call(null,writer__6204__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_14374 = (self__.level + 1);while(true){
if((i_14374 <= (new_level + 1)))
{(update[i_14374] = self__.header);
{
var G__14375 = (i_14374 + 1);
i_14374 = G__14375;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14376 = 0;while(true){
if((i_14376 <= self__.level))
{var links_14377 = (update[i_14376]).forward;if(((links_14377[i_14376]) === x__$1))
{(links_14377[i_14376] = (x__$1.forward[i_14376]));
{
var G__14378 = (i_14376 + 1);
i_14376 = G__14378;
continue;
}
} else
{{
var G__14379 = (i_14376 + 1);
i_14376 = G__14379;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__5636__auto__ = (cljs.core.truth_((function (){var and__5624__auto__ = me;if(cljs.core.truth_(and__5624__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__5624__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__5636__auto__))
