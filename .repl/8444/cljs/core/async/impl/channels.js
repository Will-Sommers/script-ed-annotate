...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14464 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14464 = (function (val,box,meta14465){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14464.cljs$lang$type = true;
cljs.core.async.impl.channels.t14464.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14464";
cljs.core.async.impl.channels.t14464.cljs$lang$ctorPrWriter = (function (this__6203__auto__,writer__6204__auto__,opt__6205__auto__){return cljs.core._write.call(null,writer__6204__auto__,"cljs.core.async.impl.channels/t14464");
});
cljs.core.async.impl.channels.t14464.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14464.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14466){var self__ = this;
var _14466__$1 = this;return self__.meta14465;
});
cljs.core.async.impl.channels.t14464.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14466,meta14465__$1){var self__ = this;
var _14466__$1 = this;return (new cljs.core.async.impl.channels.t14464(self__.val,self__.box,meta14465__$1));
});
cljs.core.async.impl.channels.__GT_t14464 = (function __GT_t14464(val__$1,box__$1,meta14465){return (new cljs.core.async.impl.channels.t14464(val__$1,box__$1,meta14465));
});
}
return (new cljs.core.async.impl.channels.t14464(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__6206__auto__,writer__6207__auto__,opts__6208__auto__){return cljs.core._write.call(null,writer__6207__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__6203__auto__,writer__6204__auto__,opt__6205__auto__){return cljs.core._write.call(null,writer__6204__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_14467 = self__.takes.pop();if((taker_14467 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14467))
{var take_cb_14468 = cljs.core.async.impl.protocols.commit.call(null,taker_14467);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14468,taker_14467){
return (function (){return take_cb_14468.call(null,null);
});})(take_cb_14468,taker_14467))
);
} else
{}
{
