...
{{
var G__19237 = cljs.core.pop.call(null,v__$1);
v__$1 = G__19237;
continue;
}
} else
...
{var pred__19241 = cljs.core._EQ_;var expr__19242 = limit;if(cljs.core.truth_(pred__19241.call(null,1,expr__19242)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__19241.call(null,2,expr__19242)))
...
var G__19244 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__19245 = (limit__$1 - 1);
var G__19246 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__19244;
limit__$1 = G__19245;
parts = G__19246;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___19248 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___19248))
{var replacement_19249 = temp__4090__auto___19248;buffer.append([cljs.core.str(replacement_19249)].join(''));
} else
{buffer.append(ch);
}
{
var G__19250 = (index + 1);
index = G__19250;
continue;
}
}
