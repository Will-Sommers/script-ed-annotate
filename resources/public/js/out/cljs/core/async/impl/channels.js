...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t11931 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t11931 = (function (val,box,meta11932){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t11931.cljs$lang$type = true;
cljs.core.async.impl.channels.t11931.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t11931";
cljs.core.async.impl.channels.t11931.cljs$lang$ctorPrWriter = (function (this__3970__auto__,writer__3971__auto__,opt__3972__auto__){return cljs.core._write.call(null,writer__3971__auto__,"cljs.core.async.impl.channels/t11931");
});
cljs.core.async.impl.channels.t11931.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t11931.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11933){var self__ = this;
var _11933__$1 = this;return self__.meta11932;
});
cljs.core.async.impl.channels.t11931.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11933,meta11932__$1){var self__ = this;
var _11933__$1 = this;return (new cljs.core.async.impl.channels.t11931(self__.val,self__.box,meta11932__$1));
});
cljs.core.async.impl.channels.__GT_t11931 = (function __GT_t11931(val__$1,box__$1,meta11932){return (new cljs.core.async.impl.channels.t11931(val__$1,box__$1,meta11932));
});
}
return (new cljs.core.async.impl.channels.t11931(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_11934 = self__.takes.pop();if((taker_11934 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_11934))
{var take_cb_11935 = cljs.core.async.impl.protocols.commit.call(null,taker_11934);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_11935,taker_11934){
return (function (){return take_cb_11935.call(null,null);
});})(take_cb_11935,taker_11934))
);
} else
{}
{
